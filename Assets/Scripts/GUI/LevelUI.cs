...
namespace DancingLineFanmade.UI
{
    public class LevelUI : MonoBehaviour
    {
        ...
        internal void NormalPage(float percent, int blockCount, int crownCount, bool isNewRecord)
        {
            progress = percent;
            ShowPage(true, percent, blockCount, crownCount, isNewRecord);
        }
        ...
        internal void ShowPage(bool normal, float percent, int blockCount = 0, int crownCount = 0, bool isNewRecord = false)
        {
        ...
        {
            foreach (Button b in buttonsRevive) b.interactable = false;
            NormalPage(progress, player.BlockCount, player.CrownCount, LevelManager.IsNewRecord(progress));
